import { Type } from './../../../node_modules/protobufjs/index.d';
...
export class AddEditDataPage implements OnInit {
  ...
  constructor(
    ...
    this.route.params.subscribe((data:any)=>{
      ...
      if (data.type == 'add') {
        ...
        this.isEdit = true;
        this.firebaseService.get_single_transaccion(data.type).subscribe((data:any)=>{
          console.log(data);
          this.type = data.type;
  ...
  updateTransaction(){
    ...
    return this.firebaseService.update_transaction(this.id,data).then((res:any)=>{
      console.log(res);
      this.router.navigateByUrl('/home');
    })
  }
